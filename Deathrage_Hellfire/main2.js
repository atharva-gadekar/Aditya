...
if(document.getElementById("main1").classList.contains("visible"))
{
    music.volume = 0.1;
    document.getElementById("main1").click();
}

if(document.getElementById("main3").classList.contains("visible"))
{
    if(audio[16]==1)
        {
        let vi = new Audio('./Resources/e1.ogg');
        vi.play();
        audio[16]=0
        }
}

if(document.getElementById("main6").classList.contains("visible"))
{
    if(audio[18]==1)
        {
        let vi = new Audio('./Resources/e2.ogg');
        vi.play();
        audio[18]=0
        }
}

if(document.getElementById("main9").classList.contains("visible"))
{
    if(audio[17]==1)
        {
        let vi = new Audio('./Resources/e3.ogg');
        vi.play();
        audio[17]=0
        }
}

if(document.getElementById("main15").classList.contains("visible"))
{
    if(audio[19]==1)
        {
        let vi = new Audio('./Resources/pan.ogg');
        vi.play();
        audio[19]=0
        }
}

if(document.getElementById("main31").classList.contains("visible"))
{
    if(audio[20]==1)
        {
        let vi = new Audio('./Resources/hbd.mp3');
        let vis = new Audio('./Resources/fneom.mp3');
        vi.play();
        vis.play();
        audio[20]=0
        }
}
if(document.getElementById("main13").classList.contains("visible"))
{
    music.volume = 0.001;
}

if(document.getElementById("main14").classList.contains("visible"))
{
    music.volume = 0.1;
}
...
{
    document.getElementById("main17").click();
    document.getElementById("main17").addEventListener("click",()=>{
    music.volume = 0.05;
    if(audio[1]==1)
        {
...
if(document.getElementById("main30").classList.contains("visible"))
{
    if(audio[14]==1)
    {
    let vi = new Audio('./Resources/morty.mpeg');
    vi.play();
    audio[14]=0
    }
}
